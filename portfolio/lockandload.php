...
<section class="cd-intro" id="portfoliohero6" style="height:430px;">
...
<section id="about" style="padding-top: 40px;">
    <div class="container about-container wow fadeInUp">
        ...
        <div class="row">
            <div class="card-deck">
                <div class="card  ">
                    <h5 class="card-header" style="font-weight: bold;font-size: 20px;text-align: center;padding-bottom: 5%;background-color: #E9EAEA">Gun Customization</h5>
                    <div class="card-body">
                        <p class="card-text">
                ...
                <div class="card  ">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            Lock & Load features many player customization options to differentiate yourself from the enemy players, such as a wide variety of helmets to choose from, multiple armor colors, multiple armor lighting colors and multiple colors to choose fromf or your bullet tracers.
                        </p>
                    </div>
