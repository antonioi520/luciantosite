...
<section class="cd-intro" id="portfoliohero2" style="height:430px;">
    <div class="hero-container cd-intro-content mask">
        <div class="wow fadeIn" style="margin-top: 360px;">
            ...
            <br>
            <div style="text-align: center"><a href="https://www.mialmarestaurant.com" target="_blank" class="visitSite">Visit Site</a></div>
        </div>
    </div>
</section>
...
<section id="about" style="padding-top: 40px;">
    <div class="container about-container wow fadeInUp">
        <div style="text-align: center"><h1 style="font-weight: bold;color:black;font-size: 50px;">Mi Alma Restaurant</h1></div>
