...
<section class="cd-intro" id="hero" style="height:430px;" >
    <div class="hero-container cd-intro-content mask">
        <div class="wow fadeIn">
            ...
            <h1 data-content="Database Management" style="font-weight: 600; margin-top:30px;"><span>Database Management</span></h1>
        </div>
    </div>
</section>
...
<section id="about" style="padding-top: 40px;">
    <div class="container about-container wow fadeInUp">
        ...
        <div class="row">
            ...
            <div class="col-md-7 about-content">
                <h1 style="font-weight: bold;font-size: 50px;color:black;">Why do I need a database?</h1>
                <div class="section-title-divider" style="width:100%;float:left;margin-bottom: 0px;"></div><br>
                <p class="about-text">
        ...
        <div class="row">
            ...
            <div class="col-md-7 about-content">
                <h1 style="font-weight: bold;font-size: 50px;color:black;">Managing Your Database</h1>
                <div class="section-title-divider" style="width:100%;float:left;margin-bottom: 0px;"></div><br>
                <p class="about-text">
        ...
        <div class="row">
            ...
            <div class="col-md-7 about-content">
                <h1 style="font-weight: bold;font-size: 50px;color:black;">Database Security</h1>
                <div class="section-title-divider" style="width:100%;float:left;margin-bottom: 0px;"></div><br>
                <p class="about-text">
