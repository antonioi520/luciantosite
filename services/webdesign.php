...
<section class="cd-intro" id="hero" style="height:430px;" >
    <div class="hero-container cd-intro-content mask">
        <div class="wow fadeIn">
            ...
            <h1 data-content="Web Design" style="font-weight: 600; margin-top:30px;"><span>Web Design</span></h1>
        </div>
    </div>
</section>
...
<br><br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div style="text-align: center;" id="testid"><a href="../inquiry.php" class="page-button getstartedbutton">Get Started Now</a></div>
        </div>
        <div class="col-md-4"></div>
